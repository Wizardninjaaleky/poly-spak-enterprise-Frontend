          ...
          <div className="lg:w-1/4">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <nav className="space-y-2">
                {adminTabs.map((tab) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-md transition-colors ${
                      activeTab === tab.id ? "bg-red-100 text-red-700" : "text-gray-700 hover:bg-gray-100"
                    }`}
                  >
                ...
                <button onClick={() => setActiveTab('add-edit-product')} className="w-full text-left px-4 py-3 rounded-md mt-4 bg-green-600 text-white">+ Add Product</button>
              </nav>
            </div>
          </div>

          <div className="lg:w-3/4">
            <div className="bg-white rounded-lg shadow p-6">{renderActive()}</div>
          </div>
        </div>
      </div>
    </div>
