...
echo "🚀 Polyspack E-commerce Platform - Render Deployment Guide"
echo "========================================================"
echo ""
...
echo "🔧 Backend Deployment (Web Service):"
echo "-------------------------------------"
...
echo "PORT=10000"
echo "MONGO_URI=mongodb+srv://alexnyakundi56_db_user:Admin@cluster0.lgqojwx.mongodb.net/polyspack-ecommerce"
echo "JWT_SECRET=a1b2c3d4e5f67890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"
echo "JWT_EXPIRE=30d"
...
echo "PAYBILL_NUMBER=522533"
echo "ACCOUNT_NUMBER=8011202"
echo ""

echo "🎨 Frontend Deployment (Static Site):"
echo "-------------------------------------"
